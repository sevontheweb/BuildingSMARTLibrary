...
public class Part21Parser implements Part21ParserConstants {
    ...
    private EntityInstanceVisitor visitor;
	...
	if (this.schema == null) {
	    ...
	    InputStream inputStream = getClass().getResourceAsStream(schemaFile);
	    try {
    ...
    public EntityInstanceVisitor getVisitor() {
	return visitor;
    }

    public void setVisitor(EntityInstanceVisitor visitor) {
	if (visitor == null) {
